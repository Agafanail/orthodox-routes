...
- две связанные области «Ищут место» и «Предлагают поездки»: пассажирские summary остаются в своём разделе, а регулярные даты и разовые поездки собраны в одном безопасном блоке «Уже договорились» после активных предложений;
