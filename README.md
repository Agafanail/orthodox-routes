...
Информационная архитектура завершена на уровне утверждённого документа; фактические card sorting и tree testing ещё предстоят. Текущий утверждённый этап — Initial Design System. Он не разрешает в рамках документационной задачи реализацию backend, UI или следующих этапов.
