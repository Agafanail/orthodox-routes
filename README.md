...
- an application-owned map-provider adapter contract with a deterministic local fake, so the whole domain and its tests run without a provider account, network access, or spend.
