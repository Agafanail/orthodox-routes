...
**Когда входа нет.** Если в группе нет активных поездок, действия входа не существует. Если активный фильтр не содержит ни одного объекта карты, пустая карта не предлагается: соответствующий фильтр недоступен и рядом видна причина.
