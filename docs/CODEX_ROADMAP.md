...
- Migrate the approved transport-board domain model from browser storage — source entities, ownership, safe projections, and date-specific occurrences are implemented locally; responses, agreements, and application cutover remain.
