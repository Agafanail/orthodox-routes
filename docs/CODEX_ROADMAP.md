...
- Implement the passwordless email identity/session foundation — completed locally; the isolated staging Auth callback and owner-configured Resend SMTP sender are configured, while actual external receipt remains unverified and production email is absent.
