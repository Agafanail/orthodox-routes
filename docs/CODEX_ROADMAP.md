...
- Implement the passwordless email identity/session foundation — completed locally and configured in isolated staging; real external email-link delivery remains unverified and production email is absent.
